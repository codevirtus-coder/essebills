...
export function HomeForWho() {
  ...
  return (
    <section
      id="audience"
      className="bg-slate-50/60 dark:bg-slate-950 py-20 sm:py-28 px-4 sm:px-6 lg:px-8"
    >
          ...
          {audiences.map(
            (
              ...
              >
                ...
                <p
                  className={`text-sm leading-relaxed mb-5 ${featured ? "text-slate-700 dark:text-slate-300" : "text-slate-500 dark:text-slate-400"}`}
                >
                  {description}
                </p>
                <ul className="space-y-2.5 mb-7 flex-1">
                  {perks.map((perk) => (
                    <li
                      key={perk}
                      className={`flex items-center gap-2.5 text-sm ${featured ? "text-slate-700 dark:text-slate-300" : "text-slate-600 dark:text-slate-400"}`}
                    >
                      <CheckCircle2
                        size={14}
                ...
                <Link
                  ...
                  className={`inline-flex items-center justify-center gap-2 font-bold text-sm px-5 py-3.5 rounded-sm transition-all ${
                    featured
                      ? "bg-[#10B981] text-white hover:bg-[#0ea472] shadow-lg shadow-[#10B981]/20"
