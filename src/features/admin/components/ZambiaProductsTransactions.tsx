...
const ZAMBIA_PRODUCTS = [
  ...
  {
    label: "Liquid Telecom",
    slug: "liquid-telecom",
    endpoint: "/v1/liquid-telecom-transactions",
  },
  { label: "Topstar", slug: "topstar", endpoint: "/v1/topstar-transactions" },
  {
    label: "Madison Life",
    slug: "madison-life",
    endpoint: "/v1/madison-life-transactions",
  },
  { label: "Afribus", slug: "afribus", endpoint: "/v1/afribus-transactions" },
  {
    label: "Vodafone",
    slug: "vodafone",
    endpoint: "/v1/vodafone-transactions",
  },
];
...
const ZambiaProductsTransactions: React.FC = () => {
  ...
  const getStatusBadge = (status: string) => {
    ...
    const isPending =
      statusUpper.includes("PENDING") || statusUpper.includes("PROCESSING");
    const isFailed =
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-dark-text dark:text-white">
            Zambia Products Transactions
          </h2>
          <p className="text-sm text-neutral-text">
            View and manage all Zambia-based product transactions.
          </p>
        </div>
