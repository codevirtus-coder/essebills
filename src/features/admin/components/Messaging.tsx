  ...
  const renderTemplates = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in slide-in-from-bottom-4 duration-500">
      {MOCK_TEMPLATES.map((tmpl) => (
        <div key={tmpl.id} className="bg-white  p-8 rounded-[2.5rem] border border-neutral-light dark:border-white/5 hover:border-primary/30 transition-all group flex flex-col justify-between">
           <div>
              ...
              <h4 className="text-xl font-black text-dark-text dark:text-white mb-4">{tmpl.name}</h4>
  ...
  return (
    <div className="p-8 space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <h2 className="text-3xl font-black text-dark-text dark:text-white tracking-tight">Messaging Center</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
         {[
           ...
           <div key={i} className="bg-white  p-6 rounded-[2rem] border border-neutral-light dark:border-white/5 flex items-center gap-4 shadow-sm">
              ...
              <div>
                 ...
                 <h4 className="text-xl font-black text-dark-text dark:text-white">{stat.v}</h4>
              </div>
           </div>
         ))}
      </div>
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in duration-500">
             <div className="bg-white  p-10 rounded-[3rem] border border-neutral-light dark:border-white/5 space-y-8">
                <div className="flex items-center gap-4 border-b border-neutral-light dark:border-white/5 pb-4">
                   ...
                   <h4 className="text-lg font-black dark:text-white">SMS Provider (Twilio)</h4>
                </div>
                <div className="space-y-4">
                   <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase text-neutral-text">Account SID</label>
                      <input type="password" value="AC8821*****************" className="w-full bg-neutral-light/20 dark:bg-white/5 border-none rounded-xl p-3 text-sm font-mono" readOnly />
                   </div>
                   <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase text-neutral-text">Auth Token</label>
                      <input type="password" value="*********" className="w-full bg-neutral-light/20 dark:bg-white/5 border-none rounded-xl p-3 text-sm font-mono" readOnly />
                   </div>
                </div>
             ...
             <div className="bg-white  p-10 rounded-[3rem] border border-neutral-light dark:border-white/5 space-y-8">
                <div className="flex items-center gap-4 border-b border-neutral-light dark:border-white/5 pb-4">
                   ...
                   <h4 className="text-lg font-black dark:text-white">Email Provider (SendGrid)</h4>
                </div>
                <div className="space-y-4">
                   <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase text-neutral-text">API Key</label>
                      <input type="password" value="SG.vV*****************" className="w-full bg-neutral-light/20 dark:bg-white/5 border-none rounded-xl p-3 text-sm font-mono" readOnly />
                   </div>
                   <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase text-neutral-text">Verified Sender</label>
                      <input type="text" value="noreply@esebills.com" className="w-full bg-neutral-light/20 dark:bg-white/5 border-none rounded-xl p-3 text-sm font-bold" readOnly />
                   </div>
                </div>
                <div className="flex items-center justify-between pt-4">
                   <span className="text-[10px] font-black text-accent-green uppercase">Service Online</span>
